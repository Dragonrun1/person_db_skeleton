...
final class Version20191216000001 extends AbstractMigration {
    ...
    public function down(Schema $schema): void {
        if ('mysql' === $this->connection->getDatabasePlatform()
                                         ->getName()) {
    ...
    public function up(Schema $schema): void {
        if ('mysql' === $this->connection->getDatabasePlatform()
            ...
            (
                ...
                UNIQUE INDEX `unq_t_class_type` (`class_name`, `type`),
                PRIMARY KEY (`id`)
            ...
            (
                ...
                `photo_id`         BINARY(22)   DEFAULT NULL COMMENT '(DC2Type:uuid64)',
                `pronoun_id`       BINARY(22)   DEFAULT NULL COMMENT '(DC2Type:uuid64)',
            ...
            (
                `address_id` BINARY(22) NOT NULL COMMENT '(DC2Type:uuid64)',
                `person_id`  BINARY(22) NOT NULL COMMENT '(DC2Type:uuid64)',
                `type_id`    BINARY(22) NOT NULL COMMENT '(DC2Type:uuid64)',
            ...
            (
                `email_id`   BINARY(22) NOT NULL COMMENT '(DC2Type:uuid64)',
                `person_id`  BINARY(22) NOT NULL COMMENT '(DC2Type:uuid64)',
                `type_id`    BINARY(22) NOT NULL COMMENT '(DC2Type:uuid64)',
                `comment`    TEXT DEFAULT NULL,
                `created_at` DATETIME   NOT NULL COMMENT '(DC2Type:datetime_immutable)',
            ...
            (
                `person_id`  BINARY(22) NOT NULL COMMENT '(DC2Type:uuid64)',
                `phone_id`   BINARY(22) NOT NULL COMMENT '(DC2Type:uuid64)',
                `type_id`    BINARY(22) NOT NULL COMMENT '(DC2Type:uuid64)',
                `comment`    TEXT DEFAULT NULL,
                `created_at` DATETIME   NOT NULL COMMENT '(DC2Type:datetime_immutable)',
